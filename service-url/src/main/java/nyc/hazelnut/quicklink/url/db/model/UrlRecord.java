package nyc.hazelnut.quicklink.url.db.model;

import java.util.Date;
import java.util.Locale;
import org.hibernate.annotations.CreationTimestamp;
import org.hibernate.annotations.GenericGenerator;
import nyc.hazelnut.quicklink.url.db.config.DatabaseConfig.Table.UrlRecords;
import nyc.hazelnut.quicklink.url.db.util.UniqueRandomIdGenerator;
